                      ...
                      <div class="col-lg-12">
                        <div class="p-4">
                          ...
                          <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="id" name="id" placeholder="NIM / NIP / NIK">
                          </div>
                          <button type="button" onclick="one('b','a')" class="btn btn-success">Next</button>
